package com.wyt.first;

import com.wyt.first.controller.HelloController;
import com.wyt.first.value.BlogProperties;
...
public class FirstApplicationTests {
    ...
    public void getDesc() throws Exception {
        Assert.assertEquals(properties.getName(), "wyt");
